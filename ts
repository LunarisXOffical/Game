...
local function loadMainScript()
    ...
    if success then
        ...
        successFrame.Size = UDim2.new(0, 200, 0, 60)
        successFrame.Position = UDim2.new(0.5, -100, 0.9, -30)
        successFrame.BackgroundColor3 = Color3.fromRGB(40, 180, 100)
        successFrame.Parent = successScreen
        Utils.Round(successFrame, 8)
        ...
        errorFrame.Parent = errorScreen
        Utils.Round(errorFrame, 8)
        
        local errorText = Instance.new("TextLabel")
        errorText.Size = UDim2.new(1, -20, 0.7, -10)
        errorText.Position = UDim2.new(0, 10, 0, 10)
        errorText.BackgroundTransparency = 1
        errorText.Text = "Failed to load script:\n" .. tostring(err):sub(1, 100)
